...
public final class ConditionalLabeler extends Decorator implements TranslatablePiece {
  ...
  public ConditionalLabeler(String s, GamePiece d) {
    mySetType(s);
    setInner(d);
  }
...
// FIXME: We should be drawing the text at the right size, not scaling it!
  ...
  private static class Ed implements PieceEditor {
    ...
    public Ed(ConditionalLabeler l) {
      ...
      propertyMatch = new PropertyExpressionConfigurer(null, "Display when properties match:  ", l.propertyMatch);
